...
│   ├── gossip/          # SWIM-like membership protocol
...
Contributions are welcome! Please read the design document in `distributed_key_value_cache.txt` for architecture details.